                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                            ...
                            @else
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                                        <div class="product-description-label">{{ translate('Max Bid Price')}}:</div>
                                    </div>
                                    <div class="col-10">
                                        <div class="product-price">
                                            <strong>
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                                        <div class="product-description-label">{{ translate('Bid End Date')}}:</div>
                                    </div>
                                    <div class="col-10">
                                        <div class="product-price">
                                            <!-- @php 
                                            $end_date = Carbon\Carbon::parse($detailedProduct->end_date);

                                            $now_date = Carbon\Carbon::now();

                                            $time_left = $end_date->diff($now_date)->format('%d/%m/%Y %g:%i %A');
                                             @endphp  -->
                                            <p>
                                                 {{ Carbon\Carbon::parse($detailedProduct->end_date)->format('d/m/Y g:i A') }}
                                             </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="{{route('cart.addToCart.product')}}" method="post">
                                ...
                                <div class="row no-gutters pb-3" id="chosen_price_div">
                                    ...
                                    <div class="col-10">
                                        <div class="product-price">
                                            <strong id="chosen_price">
                                                <input type="type" name="bidding_price" class="form-control">
                                            </strong>
                                        </div>
                                    </div>
                                    @error('bidding_price')
                                ...
                                //$time_left = $end_date->diff($now_date)->format('%d/%m/%Y %g:%i %A');
                                 @endphp 
                                @if(Auth::id() != $detailedProduct->user_id )
                                <button class="btn btn-styled btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" type="submit">
