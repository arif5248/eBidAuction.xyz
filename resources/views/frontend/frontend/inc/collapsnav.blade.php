                        ...
                        <div class="position-div">
                            <ul>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupported">
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-tshirt ml-2 mr-3"></i>Clothing,Shoes & Jewelry</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-paint-brush ml-2 mr-3"></i>Beauty</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-camera-retro ml-2 mr-3"></i>Electronics</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-baby ml-2 mr-3"></i>Baby Products</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-mobile-alt ml-2 mr-3"></i>Cell Phone & Accessories</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-heartbeat ml-2 mr-3"></i>Health & Personal Care</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-book ml-2 mr-3"></i>Books</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-volleyball-ball ml-2 mr-3"></i>Toy & Games</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('product.category') }}"><i class="fas fa-gamepad ml-2 mr-3"></i>Video Games</a>
                                        <div class="sub-menu">
                                            <div class="row">
                                                <div class="col-8">
                                                    <div class="row ml-3 mb-1">
                                    ...
                                    <li><a href="{{ route('automobile') }}" class="ml-2">Automobiles</a></li>
