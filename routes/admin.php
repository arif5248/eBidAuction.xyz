...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/brands/destroy/{id}', 'BrandController@destroy')->name('brands.delete');
	Route::get('/brands/approve/{id}', 'BrandController@approve')->name('brands.approve');

	// Order details route test
	Route::post('sale/orders/details', 'OrderController@sale_order_details');
	...
	Route::post('/seller/commission', 'SellerController@setCommission')->name('seller.set.commission');
	Route::get('/seller/social/list', 'SellerController@SellerSocialList')->name('seller.social.list');
	Route::get('/seller/social/approve/{id}', 'SellerController@SellerLinkApprove')->name('seller.links.approve');
	Route::get('/seller/social/remove/{id}', 'SellerController@SellerLinkRemove')->name('seller.links.remove');

	Route::get('/bkash/list', 'OrderController@bkashlist')->name('sales.bkash.list');
	Route::get('/bkash/approve/{id}', 'OrderController@bkashapprove')->name('sales.bkash.approved');  
	Route::get('/bkash/rejected/{id}', 'OrderController@bkashreject')->name('sales.bkash.rejected');
	...
	Route::get('/refer/bonus','HomeController@referBonus')->name('refer.bonus');
	Route::get('refer/bonus/edit/{id}','HomeController@editReferBonus')->name('refer.bonus.edit');
	Route::post('refer/bonus/update/{id}', 'HomeController@updateReferBonus')->name('refer.bonus.update');
	...
	Route::post('/orders/details', 'OrderController@sale_order_details');
	Route::get('/orders/delivery/request', 'OrderController@admin_orders_delivery_request')->name('orders.delivery.request');
	Route::get('/orders/return/request', 'OrderController@admin_orders_return_request')->name('orders.return.request.list');
	Route::get('admin/return/request/{order_id}', 'OrderController@admin_return_request')->name('admin.return.approve');  
