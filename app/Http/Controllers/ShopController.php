...
class ShopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(Shop::where('user_id', $user->id)->first() == null){
            ...
            $shop->trade_licence = $request->trade_licence;
            $shop->longitute = $request->longitude;
            $shop->latitute = $request->latitude;
    ...
    public function update(Request $request, $id)
    {
        ...
        if($shop->save()){
            $addSocialLinks = SellerSocial::where('shop_id',$id)->first();

            if($addSocialLinks){
                $addSocialLinks->shop_id = $id;
                $addSocialLinks->facebook = $request->facebook;
                $addSocialLinks->google = $request->google;
                $addSocialLinks->twitter = $request->twitter;
                $addSocialLinks->youtube = $request->youtube;
                $addSocialLinks->status = 0;
                $addSocialLinks->save();
            }else{
                $addSocialLinks = new SellerSocial;
                $addSocialLinks->shop_id = $id;
                $addSocialLinks->facebook = $request->facebook;
                $addSocialLinks->google = $request->google;
                $addSocialLinks->twitter = $request->twitter;
