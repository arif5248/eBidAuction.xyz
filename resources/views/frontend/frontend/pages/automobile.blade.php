            ...
            <div class="col-sm-9">
                ...
                <div class="simple-list-grid">
                    <ul class="list-grid-ul">
                        <a href="{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_1.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                        ...
                        <a href="{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_2.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                        ...
                        <a href="{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_3.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                        ...
                        <a href="{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_4.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                        ...
                        <a href="{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_5.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                        ...
                        <a href="{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_8.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                        ...
                        <a href="p{{ route('product.details') }}" style="text-decoration: none">
                            <li>
                                <div class="thumb">
                                    <img src="{{ asset('frontend/img/tv_6.jpg') }}" alt="gallery image or whatever" />
                                </div>
                                <div class="data">
                                    <div><b>
                                        Aliquip Commodo
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="thumb-wrapper">
                                <div class="img-box">
                                    <img src="{{ asset('frontend/img/product-1.jpg') }}" class="img-responsive img-fluid" alt="product">
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="thumb-wrapper">
                                <div class="img-box">
                                    <img src="{{ asset('frontend/img/product-2.jpg') }}" class="img-responsive img-fluid" alt="product">
                                </div>
                                <div class="timer mt-2">
                                    <div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="thumb-wrapper">
                                <div class="img-box">
                                    <img src="{{ asset('frontend/img/product-3.jpg') }}" class="img-responsive img-fluid" alt="product">
                                </div>
                                <div class="timer mt-2">
                                    <div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="thumb-wrapper">
                                <div class="img-box">
                                    <img src="{{ asset('frontend/img/product-4.jpg') }}" class="img-responsive img-fluid" alt="product">
                                </div>
                                <div class="timer mt-2">
                                    <div>
