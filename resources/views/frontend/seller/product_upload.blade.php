                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker" data-placeholder="{{ translate('Select a brand') }}" id="brands" name="brand_id">
                                                    ...
                                                    @foreach (\App\Brand::all()->where('status','1') as $brand)
                                        ...
                                        <div class="col-md-2">
                                         <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#addBrand">
...
<div class="modal fade" id="addBrand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                <form class="form-horizontal" action="{{ route('add.brands') }}" method="POST" enctype="multipart/form-data">
            @csrf
