...
<head>
    ...
    <link href="{{ my_asset('css/main.css')}}" rel="stylesheet">
    <link href="{{ my_asset('css/default.css')}}" rel="stylesheet">
    ...
    <link href="{{ my_asset('css/sweetalert2.min.css')}}" rel="stylesheet">  
    ...
    <script src="{{ my_asset('plugins/switchery/sweetalert2.min.js') }}"></script>
