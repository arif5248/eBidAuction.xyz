                                                        ...
                                                        <td>
                                                            <span class="badge badge--2 mr-4">
                                                                @if ($order->payment_status == 'paid')
                                                                    <i class="bg-green text-dark"></i> {{ translate('Paid')}}
                                                                @else
                                                                    <i class="bg-red text-dark"></i> {{ translate('Unpaid')}}
                                                                @endif
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="">
                                                                    ...
                                                                    @if(!$order->orderDetails->first()->return_request =='buyer_requested')
                                                                    <a href="{{ route('customer.return.request', $order->id) }}" class="dropdown-item">{{ translate('Return')}}</a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </td>
