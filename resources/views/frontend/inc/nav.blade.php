        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col">
                    ...
                    @endif --}}
{{-- 
                        <li class="dropdown fontsize" id="lang-change">
                            @php
                ...
                <div class="col-12 col-lg-9 text-right py-2">
                    <ul class="inline-links">
                        ...
                        @if (\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                        <li style="background-color: rgb(212, 21, 7)">
                       
                           
                                <a href="{{ route('shops.create') }}" class="btn btn-base-1 btn-icon-left" style="color:white">
                                    {{ translate('Become a seller') }}
                                </a>
    ...
    <div class="position-relative logo-bar-area" style="background-color: darkblue;" >
        <div class="">
            <div class="container">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="navbar-brand w-100" href="{{ route('home') }}">
                                ...
                                @if($generalsetting->logo != null)
                                    <p style="font-size: 30px;font-weight: bold;">eBidAuction.xyz</p>
                                @else
                                    <p style="font-size: 30px;font-weight: bold;">eBidAuction.xyz</p>
                                @endif
                    ...
                    <div class="col-lg-9 col-4 position-static">
                        <div class="d-flex w-100">
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" onclick="getLocation()" class="w-100" placeholder="{{translate('I am shopping for...')}}" autocomplete="off"> 
                                        ...
                                        <div class="form-group category-select d-none d-xl-block" >
                                            <select class="form-control selectpicker text-white" name="category" >
                                        ...
                                        <button class="d-none d-lg-block" type="submit" style="background-color:#F57224">
                                            <i class="la la-search la-flip-horizontal" style="color: #212529"></i>
                                        </button>
                            ...
                            <div class="logo-bar-icons d-inline-block ml-auto">
                                ...
                                <div class="d-none d-lg-inline-block p-1" style="background-color:#F57224 ">
                                    <div class="nav-compare-box" id="compare">
                                        <a href="{{ route('compare') }}" class="nav-box-link">
                                            <i class="fas fa-filter d-inline-block nav-box-icon text-white"></i>
                                            <span class="nav-box-text d-none d-xl-inline-block text-white">{{translate('Compare')}}</span>
                                            @if(Session::has('compare'))
                                ...
                                <div class="d-none d-lg-inline-block p-1" style="background-color:#F57224 ">
                                    <div class="nav-wishlist-box" id="wishlist">
                                        <a href="{{ route('wishlists.index') }}" class="nav-box-link">
                                            <i class="fas fa-gift d-inline-block nav-box-icon text-white"></i>
                                            <span class="nav-box-text d-none d-xl-inline-block text-white">{{translate('Wishlist')}}</span>
                                            @if(Auth::check())
                                ...
                                <div class="d-inline-block p-1" data-hover="dropdown" style="background-color:#F57224 ">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="la la-shopping-cart d-inline-block nav-box-icon text-white"></i>
                                            <span class="nav-box-text d-none d-xl-inline-block text-white">{{translate('Cart')}}</span>
                                            @if(Session::has('cart'))
