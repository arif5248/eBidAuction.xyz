    ...
    <div class="widget mb-0">
        ...
        <div class="widget-profile-menu py-3">
            <ul class="categories categories--style-3">
                ...
                <li>
                    <a href="{{ route('orders.return') }}" class="{{ areActiveRoutesHome(['orders.return'])}}">
                        <i class="la la-file-text"></i>
                        <span class="category-name">
                            {{ translate('Return Orders')}} @if($orders > 0)<span class="ml-2" style="color:green"><strong>({{ $orders }} {{  translate('New') }})</strong></span></span>@endif
                        </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('refer.friends') }}" class="{{ areActiveRoutesHome(['refer.friends'])}}">
                        <i class="la la-support"></i>
                        <span class="category-name">
                ...
                <li>
                    <a href="{{ route('seller.product.bids') }}" class="{{ areActiveRoutesHome(['seller.product.bids'])}}">
                        <i class="la la-support"></i>
                        <span class="category-name">
                            {{translate('Customer Bids')}}
                        </span>
                    </a>
                </li>
                <li>
                    @php 
                    $shop_slug = App\Shop::where('user_id',Auth::id())->first();
                    @endphp
                    <a href="{{ route('shop.visit', $shop_slug->slug) }}" class="{{ areActiveRoutesHome(['shop.visit'])}}">
                        <i class="la la-support"></i>
                        <span class="category-name">
                            {{translate('View a Buyer')}}
                        </span>
                    </a>
                </li>
            </ul>
