...
<link rel="stylesheet" href="{{ my_asset('css/css/style.css') }}">
<link rel="stylesheet" href="{{ my_asset('css/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ my_asset('css/css/all.min.css') }}">
<link rel="stylesheet" href="{{ my_asset('css/css/responsive.css') }}">
...
<script src="{{ my_asset('js/timer.js') }}"></script>
...
<script>
    ...
    function search(){
        ...
        if(search.length > 0){
            ...
            $.get('{{ route('search.ajax') }}', { search:search, longitude: longitude, latitude: latitude}, function(data){
                console.dir(data)
                if(data == '0'){
