                    ...
                    <div class="sub-category-menu @php if($key < 12) echo 'active'; @endphp" id="{{ $key }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-6">
                                ...
                                <h6 class="mb-3"><img loading="lazy"  class="cat-image" src="{{ my_asset($subcategory->icon) }}" style="height: 30px;width: 30px"><a href="{{ route('products.subcategory', $subcategory->slug) }}">{{  __($subcategory->name) }}</a></h6>
                                <ul class="mb-3">
                                    @foreach ($subcategory->subsubcategories as $key => $subsubcategory)
                                    <li class="w-100"><img loading="lazy"  class="cat-image" src="{{ my_asset($subsubcategory->icon) }}" style="height: 30px;width: 30px; float: left;"><a href="{{ route('products.subsubcategory', $subsubcategory->slug) }}" >{{  __($subsubcategory->name) }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            @endforeach
