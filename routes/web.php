...
Route::get('opt/verification','Auth\RegisterController@otpVerficaton')->name('otp.verification');
...
Route::post('/cart/addtocart/product', 'CartController@addToCartByProductDetails')->name('cart.addToCart.product');
...
Route::get('/ajax-search', 'HomeController@ajax_search')->name('search.ajax');
...
Route::group(['middleware' => ['user', 'verified','unbanned']], function(){
	...
	Route::get('/bids', 'CartController@bidList')->name('seller.product.bids');
	Route::get('bid/approve/{id}', 'CartController@approveBid')->name('bid.approve');

	// BKASH Store Related Route
	Route::post('/bkash/wallet/{id}', 'WalletController@bkash_store')->name('bkash.wallet_store');
...
Route::get('/customer_products/destroy/{id}', 'CustomerProductController@destroy')->name('customer_products.destroy');
	Route::get('/refet/friends', 'HomeController@referFriends')->name('refer.friends');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::get('order/return','OrderController@orders_return')->name('orders.return');
	Route::get('seller/return/approve/{order_id}', 'OrderController@seller_return_approve')->name('seller.return.approve');
	Route::get('customer/return/request/{order_id}', 'OrderController@customer_return_request')->name('customer.return.request');
	...
	Route::group(['prefix' =>'bulk-upload/download'], function(){
		...
		Route::post('add/brands','BrandController@seller_add_brands')->name('add.brands');
